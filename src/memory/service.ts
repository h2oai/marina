  ...
  capabilities() {
    return {
      ...
      retrieval: {
        ...
        operation: "retrieve",
        source_windows: true,
        selection: ["sources_first", "balanced", "records_first"],
        structural_coverage: true,
        observed_candidate_export: true,
        diagnostics: true,
        max_results: 20,
        max_bytes: 65536,
        source_bytes: 8192,
      ...
      workflows: {
        ...
        episodes: "explicit-private-journal",
        resume: true,
        recipes: "declarative-explicit-selection",
        comparison: "offline-observed-reads-only",
        notifications: "authenticated-poll-and-ack",
        guide: "docs/guides/memory-workflows.md",
      },
      federated_retrieval: { total_evidence_budget: true, consistency: "per-peer" },
      retrieval_cache: {
        temporal_contract: "explicit-valid_at-required",
        validation: "live-access-generation-and-pins",
      },
      extraction: false,
