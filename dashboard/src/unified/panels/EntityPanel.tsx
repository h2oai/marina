...
const MODEL_GROUPS = [
  ...
  {
    provider: "Google",
    models: [{ value: "google/gemini-3.1-flash-lite", label: "Gemini 3.1 Flash Lite" }],
  },
  {
    provider: "OpenRouter",
    models: [
      { value: "openrouter/openai/gpt-6-luna", label: "GPT-6 Luna" },
      { value: "openrouter/z-ai/glm-5.3-flash", label: "GLM 5.3 Flash" },
      { value: "openrouter/anthropic/claude-sonnet-5", label: "Claude Sonnet 5" },
    ],
  },
  {
    provider: "Hugging Face",
    models: [
      { value: "huggingface/zai-org/GLM-5.3-Flash", label: "GLM 5.3 Flash" },
      { value: "huggingface/openai/gpt-oss-120b", label: "gpt-oss 120B" },
    ],
  },
  { provider: "Groq", models: [{ value: "groq/openai/gpt-oss-120b", label: "gpt-oss 120B" }] },
  {
    provider: "Mistral",
